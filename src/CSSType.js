...
export type mozBorderBottomColors = string | color | 'none';
export type mozBorderLeftColors = string | color | 'none';
export type mozBorderRightColors = string | color | 'none';
export type mozBorderTopColors = string | color | 'none';
...
export type mozOutlineRadius = outlineRadius | string;
export type mozOutlineRadiusBottomleft = outlineRadius;
export type mozOutlineRadiusBottomright = outlineRadius;
export type mozOutlineRadiusTopleft = outlineRadius;
export type mozOutlineRadiusTopright = outlineRadius;
...
export type webkitMask = maskImage | string;
export type webkitMaskAttachment = attachment | string;
export type webkitMaskClip = webkitMaskClipStyle | string;
export type webkitMaskComposite = compositeStyle | string;
export type webkitMaskImage = maskImage | string;
...
export type webkitMaskRepeat = repeatStyle | string;
export type webkitMaskRepeatX = 'repeat' | 'no-repeat' | 'space' | 'round';
export type webkitMaskRepeatY = 'repeat' | 'no-repeat' | 'space' | 'round';
export type webkitTapHighlightColor = color;
export type webkitTextFillColor = color;
export type webkitTextStroke = number | color;
export type webkitTextStrokeColor = color;
...
export type brStyle =
  ...
  | 'inset'
  | 'outset';
export type borderWidth = number | 'thin' | 'medium' | 'thick';
...
export type webkitMaskClipStyle =
  | 'border'
  | 'border-box'
  | 'padding'
  | 'padding-box'
